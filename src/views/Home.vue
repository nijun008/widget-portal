    ...
    <div class="widgets-container">
      <draggable
        ...
        <template #item="{element}">
          <ItemContainer :item-data="element" />
        </template>
      </draggable>
    </div>
...
const widgetList = reactive([
  { size: [4, 2], rowfull: false, title: '飞猪', type: 'ext_link', id: 'ext_link1231', url: 'https://www.fliggy.com/', iconUrl: 'https://itab.s3.ladydaily.com/files/itab.link/logov2/avatar.png' },
  ...
  { size: [4, 4], rowfull: false, title: '飞猪', type: 'ext_link', id: 'ext_link1126431', url: 'https://www.fliggy.com/', iconUrl: 'https://itab.s3.ladydaily.com/files/itab.link/logov2/avatar.png' },
  { size: [3, 3], rowfull: false, title: '飞猪', type: 'ext_link', id: 'ext_lin3k162431', url: 'https://www.fliggy.com/', iconUrl: 'https://itab.s3.ladydaily.com/files/itab.link/logov2/avatar.png' },
  { size: [3, 2], rowfull: false, title: '飞猪', type: 'ext_link', id: 'ext_link212431', url: 'https://www.fliggy.com/', iconUrl: 'https://itab.s3.ladydaily.com/files/itab.link/logov2/avatar.png' },
